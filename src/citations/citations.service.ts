...
export class CitationsService {
  ...
  async updateNotes(updateCitationDto: UpdateCitationDto): Promise<Citation> {
    const citation = await this.findByCode(updateCitationDto.code);

    citation.notes = updateCitationDto.notes;
